import{_ as s,o as a,c as n,U as l}from"./chunks/framework.a3e4ade3.js";const A=JSON.parse('{"title":"Markdown Extension Examples111","description":"","frontmatter":{},"headers":[],"relativePath":"docs/src/markdown-examples.md"}'),e={name:"docs/src/markdown-examples.md"},p=l(`<h1 id="markdown-extension-examples111" tabindex="-1">Markdown Extension Examples111 <a class="header-anchor" href="#markdown-extension-examples111" aria-label="Permalink to &quot;Markdown Extension Examples111&quot;">​</a></h1><p>This page demonstrates some of the built-in markdown extensions provided by VitePress.</p><h2 id="syntax-highlighting" tabindex="-1">Syntax Highlighting <a class="header-anchor" href="#syntax-highlighting" aria-label="Permalink to &quot;Syntax Highlighting&quot;">​</a></h2><p>VitePress provides Syntax Highlighting powered by <a href="https://github.com/shikijs/shiki" target="_blank" rel="noreferrer">Shiki</a>, with additional features like line-highlighting:</p><p><strong>Input</strong></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">\`\`\`js{4}</span></span>
